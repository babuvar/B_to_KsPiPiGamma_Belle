...
results_dir = '/home/belle/varghese/IPHC/B_Kspipigamma_belle/toys/part2B/consolidated_results_latest3Dfit_MbcShapeBBwithoutbump'
out_dir = '/home/belle/varghese/IPHC/B_Kspipigamma_belle/toys/part2B/ensemble_plots_latest3Dfit_MbcShapeBBwithoutbump'
...
def plot_linearity(n, metric, e_metric, inputS, parname, metricname, out_dir):
	...
	can.cd(); gr.Draw("ALP")	
	can.SaveAs('%s/%s_pull_%s_linearity_new.png'%(out_dir, parname, metricname))
