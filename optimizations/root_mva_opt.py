...
##                                                                                                            ##
##  Comment : generic MC stream-2 is not used here and is witheld for having a statistically independent      ##
##  dataset for fitting.                                                                                      ##
################################################################################################################
...
#general
variables_used = ['issignal', 'rMVA', 'de', 'mbc', 'pi0veto', 'etaveto', 'g_e9e25', 'g_cos', 'tagcl', 'vtxcl', 'm23', 'x_p0_kid', 'x_p1_kid', 'x_p0_eid', 'x_p1_eid', 'x_m', 'tagh', 'tagntrk', 'vtxh'] # all variables used in program
opt_variable = 'rMVA' # the variable to be optimized
sig_variable = 'issignal'# the variable that determines the difference between signal and background

#plot labels
labels_sigEff = {
'title' : 'Signal efficiency vs ROOT CS-MVA cut',
'x' : 'cut value',
'y' : 'efficiency (%)',
'name' : 'sigEff.png'
}
...
labels_fom = {
'title' : 'Figure-of-merit vs ROOT CS-MVA cut',
'x' : 'cut value',
'y' : 'f.o.m.',
'name' : 'fom.png'
}
...
labels_dmc = {
'title' : 'Data/MC background ratio vs ROOT CS-MVA cut',
'x' : 'cut value',
'y' : 'ratio',
