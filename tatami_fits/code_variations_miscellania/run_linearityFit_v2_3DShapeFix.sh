...
./exe/linearityToyFit_v2_3DKDE -f $input_dir/toy_dataset_${smc_sample}_${toyindex}.root -p $plot_dir/toy_fit_${smc_sample}_${toyindex}.pdf -r $result_dir/result_toy_${smc_sample}_${toyindex}.txt -i $toyindex -c $consolidated_results_dir -t $smc_sample   >> $log_dir/log_toy_${smc_sample}_${toyindex}.txt
