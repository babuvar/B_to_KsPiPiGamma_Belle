...
TFile *f = new TFile("/home/belle/varghese/IPHC/B_Kspipigamma_belle/tatami_fits/alternate_way/RandomizedParameters/fix_shape/bb_randPars.root");
RooWorkspace *w_bb = (RooWorkspace *)f->Get("rws_bb_randPars");
//RooAbsData *bb_randpars_mbc = w_bb->data("mbc"); 
//RooAbsData *bb_randpars_de = w_bb->data("de");
//RooAbsData *bb_randpars_dt = w_bb->data("dt");

//bb_randpars_mbc->get(56); bb_randpars_mbc->Print("v");
//RooRealVar * par = (RooRealVar*) (bb_randpars_mbc->get(56)->find("bbMBC_c") );
//RooRealVar * par = (RooRealVar *) bb_randpars_mbc->FindObject("bbMBC_c");
//cout<<"The value of bbMBC_c = "<<par->getVal()<<endl;
cout<<"The value of bbMBC_c = "<<randParVal(w_bb, "mbc", 55, "bbMBC_c")<<endl;
cout<<"The value of bbMBC_c = "<<randParVal(w_bb, "mbc", 65, "bbMBC_c")<<endl;
cout<<"The value of bbMBC_c = "<<randParVal(w_bb, "mbc", 75, "bbMBC_c")<<endl;
