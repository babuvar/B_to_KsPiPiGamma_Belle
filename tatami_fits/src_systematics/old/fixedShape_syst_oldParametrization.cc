...
//------------------------------------------------------------------------------------------------------
	...
	cout<<"stage before random parameter fixing"<<endl;

	//Here we load the randomized parameters
	TFile *F_bb = new TFile("/home/belle/varghese/IPHC/B_Kspipigamma_belle/tatami_fits/alternate_way/RandomizedParameters/fix_shape/bb_randPars.root");
	RooWorkspace *w_bb = (RooWorkspace *)F_bb->Get("rws_bb_randPars");
	TFile *F_cont = new TFile("/home/belle/varghese/IPHC/B_Kspipigamma_belle/tatami_fits/alternate_way/RandomizedParameters/fix_shape/cont_randPars.root");
	RooWorkspace *w_cont  = (RooWorkspace *)F_cont->Get("rws_cont_randPars");
	TFile *F_rare = new TFile("/home/belle/varghese/IPHC/B_Kspipigamma_belle/tatami_fits/alternate_way/RandomizedParameters/fix_shape/rare_randPars.root");
	RooWorkspace *w_rare = (RooWorkspace *)F_rare->Get("rws_rare_randPars");
	TFile *F_scf = new TFile("/home/belle/varghese/IPHC/B_Kspipigamma_belle/tatami_fits/alternate_way/RandomizedParameters/fix_shape/scf_randPars.root");
	RooWorkspace *w_scf = (RooWorkspace *)F_scf->Get("rws_scf_randPars");
	TFile *F_signal = new TFile("/home/belle/varghese/IPHC/B_Kspipigamma_belle/tatami_fits/alternate_way/RandomizedParameters/fix_shape/signal_randPars.root");
	RooWorkspace *w_signal = (RooWorkspace *)F_signal->Get("rws_signal_randPars");	

	//BB
	if(component == "bb" || component == "all"){
	bbMBC_c->setVal(randParVal(w_bb, "mbc", toyindex, "bbMBC_c")); 
	bbMBC_m0->setVal(randParVal(w_bb, "mbc", toyindex, "bbMBC_m0"));
	bbDE_al->setVal(randParVal(w_bb, "de", toyindex, "bbDE_al"));
	bbDT_tau->setVal(randParVal(w_bb, "dt", toyindex, "bbDT_tau"));
	bbDT_mu_l->setVal(randParVal(w_bb, "dt", toyindex, "bbDT_mu_l"));
        bbDT_mu_d->setVal(randParVal(w_bb, "dt", toyindex, "bbDT_mu_d"));
        bbDT_f_delt->setVal(randParVal(w_bb, "dt", toyindex, "bbDT_f_delt"));
        bbDT_f_tail->setVal(randParVal(w_bb, "dt", toyindex, "bbDT_f_tail"));
        bbDT_S_main->setVal(randParVal(w_bb, "dt", toyindex, "bbDT_S_main"));
        bbDT_S_tail->setVal(randParVal(w_bb, "dt", toyindex, "bbDT_S_tail"));
	}
	...
	//Rare-bkg
	if(component == "rare" || component == "all"){
	rareMBC_mean->setVal(randParVal(w_rare, "mbc", toyindex, "rareMBC_mean"));
        rareMBC_sigma->setVal(randParVal(w_rare, "mbc", toyindex, "rareMBC_sigma"));
        rareMBC_alpha->setVal(randParVal(w_rare, "mbc", toyindex, "rareMBC_alpha"));
        rareMBC_n->setVal(randParVal(w_rare, "mbc", toyindex, "rareMBC_n"));
        rareMBC_c->setVal(randParVal(w_rare, "mbc", toyindex, "rareMBC_c"));
        rareMBC_m0->setVal(randParVal(w_rare, "mbc", toyindex, "rareMBC_m0"));
        rareMBC_f->setVal(randParVal(w_rare, "mbc", toyindex, "rareMBC_f"));
        rareDE_alpha->setVal(randParVal(w_rare, "de", toyindex, "rareDE_alpha"));
        rareDT_tau->setVal(randParVal(w_rare, "dt", toyindex, "rareDT_tau"));
        rareDT_mu_l->setVal(randParVal(w_rare, "dt", toyindex, "rareDT_mu_l"));
        rareDT_mu_d->setVal(randParVal(w_rare, "dt", toyindex, "rareDT_mu_d"));
        rareDT_f_delt->setVal(randParVal(w_rare, "dt", toyindex, "rareDT_f_delt"));
        rareDT_f_tail->setVal(randParVal(w_rare, "dt", toyindex, "rareDT_f_tail"));
        rareDT_S_main->setVal(randParVal(w_rare, "dt", toyindex, "rareDT_S_main"));
        rareDT_S_tail->setVal(randParVal(w_rare, "dt", toyindex, "rareDT_S_tail"));
	}

	//SCF
	if(component == "scf" || component == "all"){
	scfMBC_mean->setVal(randParVal(w_scf, "mbc", toyindex, "scfMBC_mean"));
        scfMBC_sigma->setVal(randParVal(w_scf, "mbc", toyindex, "scfMBC_sigma"));
        ...
        scfDE_alpha->setVal(randParVal(w_scf, "de", toyindex, "scfDE_alpha"));
        scfDE_mean->setVal(randParVal(w_scf, "de", toyindex, "scfDE_mean"));
        scfDE_sigma->setVal(randParVal(w_scf, "de", toyindex, "scfDE_sigma"));
        scfDE_f->setVal(randParVal(w_scf, "de", toyindex, "scfDE_f"));
