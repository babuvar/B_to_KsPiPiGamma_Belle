...
int main(int argc, char *argv[]) {
	...
	//Randomized w-tags
	TFile *F_wtag = new TFile("/home/belle/varghese/IPHC/B_Kspipigamma_belle/tatami_fits/alternate_way/RandomizedParameters/WrongTags/randWTagMetrics.root");
	RooWorkspace *w_wtag = (RooWorkspace *)F_wtag->Get("rws_randWTags");
	

        w_true[0][0] = 0.5; w_true[0][1] = 0.5; dw_true[0][0] = 0.0; dw_true[0][1] = 0.0;

        w_true[1][0] = randParVal(w_wtag, "data", toyindex, "w10"); 
	w_true[1][1] = randParVal(w_wtag, "data", toyindex, "w11"); 
	dw_true[1][0] = randParVal(w_wtag, "data", toyindex, "dw10"); 
	dw_true[1][1] = randParVal(w_wtag, "data", toyindex, "dw11");

        w_true[2][0] = randParVal(w_wtag, "data", toyindex, "w20"); 
	w_true[2][1] = randParVal(w_wtag, "data", toyindex, "w21"); 
	dw_true[2][0] = randParVal(w_wtag, "data", toyindex, "dw20"); 
	dw_true[2][1] = randParVal(w_wtag, "data", toyindex, "dw21");

        w_true[3][0] = randParVal(w_wtag, "data", toyindex, "w30"); 
	w_true[3][1] = randParVal(w_wtag, "data", toyindex, "w31"); 
	dw_true[3][0] = randParVal(w_wtag, "data", toyindex, "dw30"); 
	dw_true[3][1] = randParVal(w_wtag, "data", toyindex, "dw31");

        w_true[4][0] = randParVal(w_wtag, "data", toyindex, "w40"); 
	w_true[4][1] = randParVal(w_wtag, "data", toyindex, "w41"); 
	dw_true[4][0] = randParVal(w_wtag, "data", toyindex, "dw40"); 
	dw_true[4][1] = randParVal(w_wtag, "data", toyindex, "dw41");

        w_true[5][0] = randParVal(w_wtag, "data", toyindex, "w50"); 
	w_true[5][1] = randParVal(w_wtag, "data", toyindex, "w51"); 
	dw_true[5][0] = randParVal(w_wtag, "data", toyindex, "dw50"); 
	dw_true[5][1] = randParVal(w_wtag, "data", toyindex, "dw51");

        w_true[6][0] = randParVal(w_wtag, "data", toyindex, "w60"); 
	w_true[6][1] = randParVal(w_wtag, "data", toyindex, "w61"); 
	dw_true[6][0] = randParVal(w_wtag, "data", toyindex, "dw60"); 
	dw_true[6][1] = randParVal(w_wtag, "data", toyindex, "dw61");
