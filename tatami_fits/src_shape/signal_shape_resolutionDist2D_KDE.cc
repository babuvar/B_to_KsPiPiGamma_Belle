...
//----------------------------------------------------------------------------------------------//
	...
	//3D PDF
	//RooProdPdf * signal3D =  new RooProdPdf("signal","signal",RooArgSet(mbcde_sig, dtsignal));
...
//----------------------------------------------------------------------------------------------//
	...
	*/
	...
	TH2F * mbc_de_datahist = (TH2F *)data->createHistogram("mbc,de", 60, 60);
        TH2F * mbc_de_pdfhist = (TH2F *)mbcde_sig.createHistogram("mbc,de", 60, 60);
	...
	*/
	...
	rws->import(mbcde_sig); 
        rws->import(dtsignal);
	rws->writeToFile("pdf_models/fix_shape/signal_shape3D_KDE.root");
